...
function pickId(slug = "") {
  ...
  if (id === "csharp") return (<svg {...props}><path d="M10 24 q4 -10 14 -10 q5 0 8 3"/><path d="M10 24 q4 10 14 10 q5 0 8 -3"/><path d="M30 14 v8 M34 14 v8 M28 18 h8 M28 22 h8"/></svg>);
  if (id === "cpp")    return (<svg {...props}><path d="M30 14 a14 14 0 1 0 0 20"/><path d="M36 18 v6 M40 18 v6 M34 21 h8 M38 26 h8 M42 26 v6 M46 26 v6 M40 29 h8"/></svg>);
  if (id === "go")     return (<svg {...props}><circle cx="20" cy="24" r="3" fill="currentColor"/><circle cx="32" cy="24" r="3" fill="currentColor"/><path d="M6 20 h10 M6 24 h8 M6 28 h10"/><path d="M38 24 q4 4 0 8"/></svg>);
  if (id === "rust")   return (<svg {...props}><circle cx="24" cy="24" r="12"/><path d="M24 8 v6 M24 34 v6 M8 24 h6 M34 24 h6 M14 14 l4 4 M30 30 l4 4 M30 18 l4 -4 M14 34 l4 -4"/></svg>);
  if (id === "kotlin") return (<svg {...props}><path d="M10 10 h28 L10 38 z"/><path d="M10 10 L24 24 L10 38"/></svg>);
  return "more";
}
