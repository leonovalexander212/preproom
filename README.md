...
- **Интеграция LLM.** Для "Уточнить у ИИ" используется OpenRouter как провайдер-агрегатор.
...
- OpenAI SDK в конфигурации OpenRouter
...
- Node.js 20+
- PostgreSQL 16+
- OpenRouter API key (для LLM-фич) — получить на https://openrouter.ai/keys
